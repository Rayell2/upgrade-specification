;; asset-vault
;; 
;; This contract manages a comprehensive asset tracking system on the Stacks blockchain.
;; It allows users to register, transfer, and verify ownership of physical and digital assets
;; with detailed metadata and provenance tracking.
